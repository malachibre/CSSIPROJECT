...
C16043 = CRN(name = "ENGL1101", bld_num = 56, days = ['m', 'w', 'f'])
C16043.put()

C25093 = CRN(name= "ENGL1101", bld_num = 56, days = ['m', 'w', 'f'])
C25093.put()

C25094 = CRN(name= "ENGL1101", bld_num = 56, days = ['m', 'w', 'f'])
C25094.put()

C15353 = CRN(name= "MATH1113", bld_num = 1033, days = ['t', 'r'])
C15353.put()

C15356 = CRN(name= "MATH1113", bld_num = 1013, days = ['m', 'w', 'f'])
C15356.put()

C15359 = CRN(name= "MATH1113", bld_num = 1040, days = ['m', 'w', 'f'])
C15359.put()

C22591 = CRN(name= "HIST2112", bld_num = 66, days = ['t', 'r'])
C22591.put()

C25894 = CRN(name= "HIST2112", bld_num = 66, days = ['m', 'w'])
C25894.put()
